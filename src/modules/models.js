...
export const modelOptions = [
	...
	},
	{
		...
		options: getModels([
			...
			'raag-kalawati',
			'raag-madhukauns',
			'raag-madhymadi-sarang',
			'raag-hansdhwni'
		])
	},
	{
		label: 'Ragas -- Hexatonic',
		options: getModels([
			'raag-puriya',
			'raag-parmeshwari',
			'raag-salag-varali',
			'raag-saraswati',
			'raag-rageshree-ascending',
			'raag-rageshree-descending',
			'raag-bageshree-ascending',
			'raag-bageshree-descending',
		])
	},
	{
		label: 'Ragas - Heptatonic',
		options : getModels([
			'raag-todi',
			'raag-poorya-kalyan-ascending',
			'raag-poorya-kalyan-descending',
		])
	}
];
